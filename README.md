...
```bash
git clone https://github.com/Outsidedesyield/memory-os-476.git
cd memory-os-476
python setup.py
```
...
<!-- Last updated: 2026-06-06 16:23:17 -->
